...
const RESPONSE_LENGTH_LINES = {
  ...
  normal: "",
  long: "응답 분량: 타협 없는 극한의 장문 서사. 한 편의 영화처럼 웅장하고 세밀하게, 장면의 공기감과 오감을 자극하는 극대화된 디테일로 압도적인 몰입감을 선사할 것. 인물의 숨소리와 다층적인 내면 심리, 미묘한 감정 변화는 물론 주변 환경과 숨겨진 복선까지 슬로우 모션처럼 뜯어보듯 완벽한 퀄리티로 빈틈없이 서술.",
};
...
module.exports = { SYSTEM_PROMPT_BASE, EXTRACTION_SYSTEM_PROMPT, CONTENT_INTENSITY_LINES, RESPONSE_LENGTH_LINES, PLAYER_AGENCY_LOCK_LINE, PROMPT_VERSION };
